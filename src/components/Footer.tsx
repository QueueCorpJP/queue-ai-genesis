        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://x.com/johnbobygod" className="text-white hover:text-navy-300 transition-colors" target="_blank" rel="noopener noreferrer">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/consultation" className="text-navy-300 hover:text-white transition-colors">
                  無料相談
                </Link>
              </li>
              <li>
                <Link to="/privacy" className="text-navy-300 hover:text-white transition-colors">
                  プライバシーポリシー
                </Link>
              </li>
              <li>
                <Link to="/terms" className="text-navy-300 hover:text-white transition-colors">
                  利用規約
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-navy-700 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-navy-300 text-sm">
              © {currentYear} Queue株式会社. All rights reserved.
            </p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link to="/privacy" className="text-navy-300 hover:text-white text-sm transition-colors">
                プライバシーポリシー
              </Link>
              <Link to="/terms" className="text-navy-300 hover:text-white text-sm transition-colors">
                利用規約
              </Link>
            </div>
          </div>
